...
class LibraryStorageServiceImplTest {
    ...
    void addNewBookCorrect() throws DaoException, NotFoundException {
    ...
    void addNewBookAuthorInCorrect() {
        assertThrows(NotFoundException.class, () -> libraryStorageService.addNewBook(BOOK_NAME, MISSING_AUTHOR_ID, GENRE_NAME));
    }
